...
class HomePageContent extends StatelessWidget {
  ...
  Widget _buildBestOffers() {
    ...
    final List<Map<String, String>> offers = [
      {
        "image": "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/39a08fa2-c5d2-4dce-b74d-4d63cc19293a",
        "name": "Oferta 1",
        "description": "Descrição da oferta 1"
      },
      {
        "image": "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/922884b4-ce18-4414-8962-0b8784a19f99",
        "name": "Oferta 2",
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Padding(
              padding: const EdgeInsets.only(right: 10), // Espaçamento entre imagens
